...
export default function Teams() {
  return (
    <div className=''>
      <div className=' text-5xl mt-24 text-gray-500 font-bold flex justify-center'>Наша адреса:</div>
      <div className=' text-7xl mt-4 text-gray-400 flex justify-center'>м.Київ проспект Науки 57</div>
      <div className="fixed w-full bottom-0 p-2">
        <iframe
